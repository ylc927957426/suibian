...
import ucbanner from '../components/banner/banner'
import { Toast } from 'vant'
import {createNamespacedHelpers} from 'vuex'
import store from '../plugins/vuex'
const {mapState} = createNamespacedHelpers('tuijian')
export default {
  data () {
    return {
      count: 0,
  ...
  mounted () {
    store.dispatch('tuijian/' + 'tuijian')
  },
